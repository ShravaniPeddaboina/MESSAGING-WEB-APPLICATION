...
export default function Avatar({ userId, username, online }) {
  // Check if userId is defined and has the expected format
  if (!userId || typeof userId !== 'string' || userId.length < 10) {
    // Handle the case where userId is undefined or has an unexpected format
    return null; // or render a default avatar, or handle it in a different way
  }
